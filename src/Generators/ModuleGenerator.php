...
class ModuleGenerator extends Generator
{
    ...
    {
        return config('filament-modules.paths.generator');
    }
    ...
    {
        return config('filament-modules.modules.files');
    }
    ...
    public function generateResources()
    {
        ...
        if (GenerateConfigReader::read('page')->generate() === true) {
            $this->console->call('module:make-filament-page', [
        ...
        if (GenerateConfigReader::read('provider')->generate() === true) {
            $this->console->call('module:make-filament-provider', [
    ...
    {
        return config('filament-modules.modules.replacements');
    }
    ...
    {
        $replacements = config('filament-modules.modules.replacements');
    ...
    {
        return config('filament-modules.composer.vendor');
    }
    ...
    {
        return config('filament-modules.composer.author.name');
    }
    ...
    {
        return config('filament-modules.composer.author.email');
    }
